...
export default function AboutPage() {
  return (
    <PageTransition>
      ...
      <section className="overflow-x-clip bg-night-950 py-16 md:py-20">
        <div className="container-app">
          <div className="grid min-w-0 items-center gap-10 overflow-x-clip lg:grid-cols-2">
            <motion.div
      ...
      <section className="overflow-x-clip bg-coal py-16 md:py-20">
        <div className="container-app">
          <div className="grid min-w-0 items-center gap-10 overflow-x-clip lg:grid-cols-2">
            <motion.div
              initial={{ opacity: 0, x: -32 }}
