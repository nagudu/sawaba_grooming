...
export default function AboutPreview() {
  return (
    <section id="about-preview" className="bg-night-950 py-16 md:py-20">
      <div className="container-app grid min-w-0 items-center gap-10 overflow-x-clip lg:grid-cols-2">
        <motion.div
